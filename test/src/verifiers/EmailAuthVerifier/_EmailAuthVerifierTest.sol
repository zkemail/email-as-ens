...
import { DecodedFields } from "../../../../src/verifiers/EmailAuthVerifier.sol";

abstract contract _EmailAuthVerifierTest is Test {
    function _assertDecodedFieldsEq(DecodedFields memory decoded, DecodedFields memory expected) internal pure {
