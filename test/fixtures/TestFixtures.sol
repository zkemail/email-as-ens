...
import { LinkXCommand, XDecodedFields, XProof } from "../../src/verifiers/LinkXCommandVerifier.sol";
...
library TestFixtures {
    ...
    function linkXCommand()
        internal
        pure
        returns (LinkXCommand memory command, uint256[72] memory expectedPubSignals)
    {
        XDecodedFields memory fields = XDecodedFields({
            pubkeyHash: hex"25c40dbd781e1a284366b032fe40ab3026e55269cec1694dfe64239c88fdbb5c",
            headerHash0: hex"0000000000000000000000000000000085fb869a94511ccbaaf108f91f59b407",
            headerHash1: hex"00000000000000000000000000000000f36f89025341ed6536cbe2d0d338b7a1",
            proverAddress: "",
            owner: "0xafBD210c60dD651892a61804A989eEF7bD63CBA0",
            xHandleCapture1: "thezdev1"
        });

        XProof memory proof = XProof({ fields: fields, proof: hex"" });

        command = LinkXCommand({ xHandle: "thezdev1", ensName: "zkfriendly.eth", proof: proof });
